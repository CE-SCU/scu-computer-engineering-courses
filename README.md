...
برای مشاهده کامل چارت، روی تصویر زیر کلیک کنید:  

[![📎دانلود و مشاهده چارت کامل ](./assets/images/chart_preview.jpg)](./assets/docs/chart.pdf)


## دیگر منابع
<p align="right">
برنامه درسی بر اساس شرایط تحصیلات دانشگاهی رشته علوم کامپیوتر در مقطع لیسانس و شامل دروس دانشگاه‌های هاروارد، ام‌آی‌تی و پرینستون و سایر دانشگاه‌ها

[لینک](https://github.com/ossu/computer-science)
</p>
